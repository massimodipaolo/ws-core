...
namespace benchmark
{
    ...
    public class LargeObjectSerialization
    {
        ...
        private static IEnumerable<x.core.EventLogItem> _data = x.core.Services.Data.GetEventLogDataApi(null, 100000, x.core.EventLogQuery.Types.Source.Memory);

        [Benchmark]
        public void Deserialize()
        {
            var items = x.core.Services.Data.GetEventLogDataApi(null, 1, Source);
