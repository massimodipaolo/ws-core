    ...
    protected override IHost CreateHost(IHostBuilder builder)
    {
        ...
        builder.ConfigureServices(_ =>
        {
            ...
            _
                ...
                //.AddTransient(typeof(Ws.Core.Extensions.Data.IRepository<xCore.Models.Agenda,string>), typeof(Ws.Core.Extensions.Data.Repository.InMemory<xCore.Models.Agenda,string>))
