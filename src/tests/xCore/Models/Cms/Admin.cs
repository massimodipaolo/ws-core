...
namespace xCore.Models.Cms
{
    ...
    public class Admin_Role : IEntity<int>
    {
        ...
        public string Created_At { get; set; }
        public string Updated_At { get; set; }
        //public virtual ICollection<Admin_Permission> Permissions { get; set; }
    }
    
    public class Admin_Users_Roles_Links : IEntity<string>
    {
        public string Id { get => $"{Admin_UserId}-{Admin_RoleId}"; set => Id = value; }
        public int Admin_UserId { get; set; }
        public int Admin_RoleId { get; set; }
        //public virtual ICollection<Admin_Role> Roles { get; set; }
    }
