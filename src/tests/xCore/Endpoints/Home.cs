...
<html lang=""en"">
    ...
    <body>
        ...
        <ul class=""list-group list-group-flush"">
          ...
          <li class=""list-group-item""><samp>/api/{nameof(xCore.Endpoints.App).ToLower()}/{nameof(xCore.Models.Agenda).ToLower()}</samp> Api module <a href=""/api/{nameof(xCore.Endpoints.App).ToLower()}/{nameof(xCore.Models.Agenda)}"" target=""_blank""> => </a></li>
