...
target scan {
  ...
  dotnet sonarscanner begin /k:"ws-core-local" /d:sonar.host.url=$Env:SONAR_HOST_URL /d:sonar.login=$Env:SONAR_LOGIN /d:sonar.cs.opencover.reportsPaths="**/coverage.opencover.xml"
  dotnet build
